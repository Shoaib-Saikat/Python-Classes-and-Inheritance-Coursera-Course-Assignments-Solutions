...
class AppleBasket:
    def __init__(self, clr,num):
        self.apple_color = clr
...
a1 = AppleBasket('red',5)
a2 = AppleBasket('green', 4)




'''Define a class called BankAccount that accepts the name you want associated with your bank account in a string, 
and an integer that represents the amount of money in the account. The constructor should initialize two instance variables from those inputs: name and amt.
...
class BankAccount:
    ...
    def __str__(self):
        return 'Your account, {}, has {} dollars.'.format(self.name,self.amount)
